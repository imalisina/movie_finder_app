    ...
    return (
        <div className='my-5 w-4/5 mx-auto'>
            ...
            <div className="relative">
                ...
                <input disabled={isLoading} onBlur={(event) => setMovieQuery(event.target.value)} placeholder="Search Movies, TV Shows, Series, etc." className="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 outline-none rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" />
