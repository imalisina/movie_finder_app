        ...
        <>
            ...
            <div className='w-full absolute z-10 top-40 text-red-400 font-extrabold mx-auto text-4xl z-10'>
                ...
                <div className='w-full text-center my-4'>
                    <Link href={""} className="text-white bg-gradient-to-br from-pink-600 to-indigo-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2">
                        Pricing Plans
                    </Link>
                </div>
            </div>
